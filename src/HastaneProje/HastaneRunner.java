...
public class HastaneRunner {
	...
	public static void main(String[] args) {
		...
		System.out.println("Doktor Ýsmi: "+hastane.getDoktor().getAd());
		System.out.println("Doktor Soyisim: "+hastane.getDoktor().getSoyad());
		System.out.println("Doktor Unvaný: "+hastane.getDoktor().getUnvan());
		System.out.println("Hasta Adý: "+hastane.getHasta().getAd());
		System.out.println("Hasta Soyadý: "+hastane.getHasta().getSoyad());
